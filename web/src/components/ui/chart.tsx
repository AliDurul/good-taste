...
// recharts 3 reads tooltip/legend payload from context and no longer exposes
// the prop types — declare the injected shape explicitly instead.
export type ChartTooltipPayloadItem = {
  dataKey?: string | number
  name?: string | number
  value?: number | string
  color?: string
  // The full data point for this entry
